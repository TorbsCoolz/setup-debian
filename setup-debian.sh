...
apt install gparted xfce4-taskmanager torbrowser-launcher libreoffice thunderbird gimp tilp2 cool-retro-term xterm xfonts-cyrillic transmission-gtk vlc htop mousepad clementine -y
